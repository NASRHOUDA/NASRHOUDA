...
Étudiante ingénieure en 2ème année à l'**INPT**, spécialisée en **Cloud & IoT**.  
Passionnée par l'ingénierie des données et les pratiques DevOps, je conçois des infrastructures scalables et des pipelines de données robustes.
...
DevOps:
  ...
  - Orchestration multi-services avec Kubernetes

Développement:
  - APIs RESTful — Node.js/Express & Spring Boot
  - Applications full-stack avec React
  - Automatisation (scraping, RPA)
...
- 🔥 **Apache Spark** — traitement big data en temps réel
- 🏗️ **Terraform** — infrastructure as code
- 📨 **Apache Kafka** — streaming de données
- ⚙️ **Kubernetes avancé** — Helm, Operators
